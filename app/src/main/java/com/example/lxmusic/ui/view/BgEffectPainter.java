 ...
 *
 * File: moe.ouom.neriplayer.ui.view/BgEffectPainter (adapted for LxMusic)
 *
...
public class BgEffectPainter {
    ...
    public void showRuntimeShader(Context context, View view, boolean isNightMode) {
    ...
    public void calcAnimationBound(Context context, View view) {
        ...
        float height2 = height / parent.getHeight();
