 ...
 *
 * File: moe.ouom.neriplayer.ui.component.playback/WaveformSlider (adapted for LxMusic)
 */
...
fun WaveformSlider(
    ...
    val inactiveColor = (inactiveTint ?: MaterialTheme.colorScheme.onSurface)
        .copy(alpha = if (enabled) 0.3f else 0.18f)
