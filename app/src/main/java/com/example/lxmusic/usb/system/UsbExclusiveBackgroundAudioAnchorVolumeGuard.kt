 ...
 *
 * File: moe.ouom.neriplayer.core.player.usb.system/UsbExclusiveBackgroundAudioAnchorVolumeGuard (adapted for LxMusic)
 */
...
/** 后台音频锚点音量守卫：记录锚点启动时的系统音量快照，用户调节时换算为相对音量 */
