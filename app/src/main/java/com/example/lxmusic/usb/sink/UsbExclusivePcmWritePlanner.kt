 ...
 *
 * File: moe.ouom.neriplayer.core.player.usb.sink/UsbExclusivePcmWritePlanner (adapted for LxMusic)
 */
...
/** 单次 native 写入的分片大小规划：传输片×4、预滚上限、队列水位上限 */
